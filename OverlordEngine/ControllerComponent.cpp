...
void ControllerComponent::Initialize(const GameContext&)
{
	...
	/*capsuleControllerDesc.slopeLimit = 0.5f;
	capsuleControllerDesc.invisibleWallHeight = 20;
	capsuleControllerDesc.maxJumpHeight = 16;*/
...
#pragma warning( disable : 4244 )
	m_Controller->getActor()->setName(std::string(m_Name.cbegin(), m_Name.cend()).c_str());
