...
float gShadowMapBias = 0.0025f;//0.02//0.0025
...
VS_OUTPUT VS(VS_INPUT input)
{
	...
	//output.pos = mul(float4(input.pos, 1), mul(gWorld, gWorldViewProj));
	...
	//output.texCoord = texOffset(input.texCoord.x, input.texCoord.y);
