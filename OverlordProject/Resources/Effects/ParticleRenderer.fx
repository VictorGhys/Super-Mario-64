...
void MainGS(point VS_DATA vertex[1], inout TriangleStream<GS_DATA> triStream)
{
	...
	topLeft = origin + float3(-size / 2.0f, size / 2.0f, 0);
	topRight = origin + float3(size / 2.0f, size / 2.0f, 0);
	bottomLeft = origin + float3(-size / 2.0f, -size / 2.0f, 0);
	bottomRight = origin + float3(size / 2.0f, -size / 2.0f, 0);
